...
#include <fcntl.h> // Opzioni per funzioni che gestiscono descrittori di file fcntl() e open()
#include <stdarg.h> // Macro per gestire funzioni variadiche
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
#include <sys/types.h>
#define _GNU_SOURCE
#include <netdb.h> // Risoluzione host e protocolli
...
int listen_inet_socket(int portnum) {
	...
	// Riutilizza indirizzo evitando sporadici errori di "indirizzo già in uso"
	int opt = 1;
